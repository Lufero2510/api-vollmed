...
class ConsultaControllerTest {
    ...
    private MockMvc mvc;
    @Autowired
    private JacksonTester<DatosAgendarConsulta> agendarConsultaJacksonTester; //tranformar a tipo JSON
    @Autowired
    private JacksonTester<DatosDetallesConsulta> detallesConsultaJacksonTester; //tranformar a tipo JSON
    @MockBean
